...
function ConfirmRide({ setConfirmRidePanel, setVehicleFound }) {
    return (
        <div>
            <h5 onClick={() => setConfirmRidePanel(false)} className='text-center absolute top-0 right-2 text-2xl w-[90%]'><i className="text-gray-300 ri-arrow-down-wide-line"></i></h5>
