...
function FinishRide({ setFinishRidePanel }) {
    ...
    return (
        <div>
            <h5 onClick={() => setFinishRidePanel(false)} className='text-center absolute top-0 right-2 text-2xl w-[90%]'><i className="text-gray-300 ri-arrow-down-wide-line"></i></h5>
            ...
            <div className="flex flex-col justify-between items-center gap-2">
                ...
                <div className="mt-6 w-full">
                    ...
                    <Link to='/captain-home' className='flex items-center justify-center w-1/2 bg-green-600 text-white font-semibold p-2 rounded-lg'>Finish Ride</Link>
                    <p className='mt-10 text-xs'>Click on Finish Ride  if you've completed the payment</p>
                </div>
