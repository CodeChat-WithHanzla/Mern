...
function WaitingforDriver({ waitingForDriver }) {
    return (
        <div>
            <h5 onClick={() => waitingForDriver(false)} className='text-center absolute top-0 right-2 text-2xl w-[90%]'><i className="text-gray-300 ri-arrow-down-wide-line"></i></h5>
            <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                    <h2 className='text-lg font-medium'>Sami</h2>
